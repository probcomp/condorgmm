...
if __name__ == "__main__":
    # Temporary: load in screenshots of the scene gaussians and reconstructions.
    # TODO: replace this with code to statically generate these PNGs based
    # on the condorgmm states from `generate_multires_scenes_and_log_to_rerun`.
    ...
    top_left_images = [
        [
            imread("gaussians-100.png"),
            imread("gaussians-1k.png"),
            imread("gaussians-10k.png"),
        ],
        [
            imread("reconstruction-100.png"),
            imread("reconstruction-1k.png"),
            imread("reconstruction-10k.png"),
        ],
    ]
    bottom_left_images = [
        [imread("banana-20.png"), imread("banana-200.png"), imread("banana-2k.png")],
        [
            imread("crackerbox-20.png"),
            imread("crackerbox-200.png"),
            imread("crackerbox-2k.png"),
        ],
    ]
    ...
    dummy_top_right = [
        [imread("gsplat-100.png"), imread("gsplat-1k.png"), imread("gsplat-10k.png")],
        [data[num_gaussians]["image"] / 255.0 for num_gaussians in [100, 1000, 10000]],
    ]
    ...
    fig.savefig(
        condorgmm.get_root_path() / "condorgmm_tex/multiresolution.pdf",
        bbox_inches="tight",
        pad_inches=0,
    )
